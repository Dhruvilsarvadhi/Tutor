...
class TopSnakBar extends StatefulWidget {
  const TopSnakBar.success({
    super.key,
    ...
    this.backgroundColor = ConstColor.primary,
  ...
  @override
  TopSnakBarState createState() => TopSnakBarState();
}

class TopSnakBarState extends State<TopSnakBar> {
  @override
